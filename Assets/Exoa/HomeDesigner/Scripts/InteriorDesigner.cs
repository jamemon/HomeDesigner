...
namespace Exoa.Designer
{
    public class InteriorDesigner : MonoBehaviour
    {
        ...
        private List<Module> camGhostedObjs = new List<Module>();
        ...
        [HideInInspector]
        public Module currentPrefabOptions;
        ...
        public static GameObject FindParentObjectWithTag(GameObject go, string tag)
        {
            ...
            while (go.tag != tag && go.transform.parent != null)
            {
        ...
        public GameObject CreateObj(SceneObject so, bool isSceneObject, bool applyScaleMultiplier, Transform parent)
        {
            ...
            lastObject.transform.rotation = Quaternion.Euler(so.rotation) * lastObject.GetComponent<Module>().GetInitRotation();
        ...
        public void SelectPrefab(string name)
        {
            ...
            foreach (GameObject p in prefabs)
            {
                ...
                {
                    currentPrefab = p;
                    currentPrefabOptions = p.GetComponent<Module>();
                    return;
                }
            }
        ...
        private void Update()
        {
            ...
            overUI = Inputs.IsOverUI;
            bool altPressed = Inputs.AltPressed();
            bool isTap = Inputs.IsTap() || Inputs.IsUp();
            ...
            if (!overUI && currentPrefabOptions == null && isTap)
            {
                ...
                if (Physics.Raycast(camToMouseRay, out hit, 100, roomMask.value))
                {
                    ...
                    if (m != null)
                    {
                        ...
                        MaterialPopup.Instance.ShowMode(WallSettings.Mode.InteriorWall, selectedObject);
                        InfoPopup.Instance.Hide();
                    }
                    ...
                    if (m != null)
                    {
                        ...
                        AddObjectOutline(selectedObject);
                        CameraEvents.OnRequestObjectFocus?.Invoke(hit.collider.gameObject, false);
                        MaterialPopup.Instance.ShowMode(WallSettings.Mode.ExteriorWall, selectedObject);
                        InfoPopup.Instance.Hide();
                    }
                    ...
                    if (m != null)
                    {
                        ...
                        AddObjectOutline(selectedObject);
                        CameraEvents.OnRequestObjectFocus?.Invoke(hit.collider.gameObject, false);
                        MaterialPopup.Instance.ShowMode(WallSettings.Mode.Floor, selectedObject);
                        InfoPopup.Instance.Hide();
                    }
                    ...
                    if (m != null)
                    {
                        ...
                        AddObjectOutline(selectedObject);
                        CameraEvents.OnRequestObjectFocus?.Invoke(hit.collider.gameObject, false);
                        MaterialPopup.Instance.ShowMode(WallSettings.Mode.Roof, selectedObject);
                        InfoPopup.Instance.Hide();
                    }
                    ...
                    if (m != null)
                    {
                        ...
                        AddObjectOutline(selectedObject);
                        CameraEvents.OnRequestObjectFocus?.Invoke(hit.collider.gameObject, false);
                        MaterialPopup.Instance.ShowMode(WallSettings.Mode.Outside, selectedObject);
                        InfoPopup.Instance.Hide();
                    }
            ...
            if (!overUI && currentPrefabOptions != null)
            {
                ...
                bool isRotating = Inputs.IsRotating(false);
                ...
                if (hits.Length > 0)
                {
                    ...
                    if (!isRotating && !isTap && !escapePressed)
                    {
                        ...
                        ghostObject.transform.rotation = Quaternion.Euler(0, 90 * turns, 0) * ghostObject.GetComponent<Module>().GetInitRotation();
        ...
        private void CreateGhost(SceneObject sceneObject, Vector3 gridPos)
        {
            ...
            ghostObject.GetComponent<Module>().isGhost = true;
        ...
        private void OnClickMove()
        {
            ...
            ghostObject.ApplyLayerRecursively("Ghost");
            Module m = ghostObject.GetComponent<Module>();
            m.isGhost = true;
