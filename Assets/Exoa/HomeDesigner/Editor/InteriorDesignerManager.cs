...
namespace Exoa.Designer
{
    ...
    public class InteriorDesignerManager : EditorWindow
    {
        ...
        private void OnClickGenerateAllThumbnails()
        {
            ...
            RuntimePreviewGenerator.BackgroundColor = Color.white;//new Color(0, 0, 0, 0);
        ...
        private void OnClickSaveModules()
        {
            ...
            string content = JsonConvert.SerializeObject(modules, Formatting.Indented);
        ...
        private void OnClickSaveTabs()
        {
            ...
            string content = JsonConvert.SerializeObject(tabs, Formatting.Indented);
