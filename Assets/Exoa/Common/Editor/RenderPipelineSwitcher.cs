...
public class RenderPipelineSwitcher : EditorWindow
{
    ...
    private void ReplaceShader(string shaderName, string newShaderName)
    {
        ...
        if (s2 == null)
        {
            EditorUtility.DisplayDialog("Error", "Could not find shader " + newShaderName, "Ok");
            return;
        }
        materials.Clear();
        ...
        EditorUtility.DisplayDialog("Done!", $"{materials.Count} " + shaderName + " materials replaced.", "Ok");
