...
namespace Exoa.Designer
{
    public class UISaving : GenericLeftMenu
    {
        ...
        private void OnGUI()
        {
            if (Inputs.SavePressed())
                saveButton.onClick.Invoke();
            if (Inputs.OpenSaveFolderPressed())
        ...
        public bool SaveInternal(string name, Action<string> callback = null)
        {
            ...
            if (savingFeedback != null)
                savingFeedback.GetComponent<RectTransform>().DOAnchorPosY(-40, 1);
        ...
        private void OnSaveDone(string fileName)
        {
            ...
            if (savingFeedback != null)
                savingFeedback.GetComponent<RectTransform>().DOAnchorPosY(0, 1).SetDelay(1);
